...
// from f+1 replicas
func (n *Node) ExecCommand(ctx context.Context, in *Command) (resp *empty.Empty, err error) {
	cd := gorums.CallData{
		Message: in,
...
func RegisterClientServer(srv *gorums.Server, impl Client) {
	srv.RegisterHandler("client.Client.ExecCommand", func(ctx gorums.ServerCtx, in *gorums.Message, finished chan<- *gorums.Message) {
